                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePM" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading" href="../../employee/staff/evaluation.php">View Ratings</a>
                                <a class="nav-link text-light loading" href="../../employee/staff/department.php">Department Evaluation</a>
                            </nav>
                        </div>
